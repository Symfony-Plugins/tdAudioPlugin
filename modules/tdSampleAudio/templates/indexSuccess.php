  ...
  <?php foreach ($audios as $audio): ?>
    <li>
      <div>
        ...
        <span class="audio_cover"><?php echo image_tag($audio->getFileCover()) ?></span>
        <span class="audio_link"><?php echo link_to(__('play it', array(), 'td'), '@td_sample_video_show?file='.$video['file']) ?></span>
      </div>
    </li>
  <?php endforeach; ?>
</ul>
